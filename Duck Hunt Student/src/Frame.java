...
public class Frame extends JPanel implements ActionListener, MouseListener, KeyListener {
	...
	public void init() {// should initilize everthing
		...
		StdAudio.playInBackground("imgs/background.wav");
	}
...
// add method for space to reset the score aand gametime back to 0
	...
	public void mousePressed(MouseEvent mouse) {
		...
		Rectangle rMain = new Rectangle(ghost.getX(), ghost.getY(), ghost.getWidth(), ghost.getHeight());
		// collision
		if (rMouse.intersects(rMain)) {
			...
			boundY = boundY * -1;
			score += 1;
			StdAudio.playInBackground("imgs/yell.wav");
...
//successful click//dog needs to move in the same -x pos
	...
	public void keyPressed(KeyEvent arg0) {
		...
		if (arg0.getKeyCode() == 32 && on == 1) {
			...
			roundTimer = 15;
			wave += 1;
			StdAudio.playInBackground("imgs/newGame.wav");
